		...
		<form:form class="form-horizontal" method="post">		
			<fieldset>
				...
				<div class="form-group">
					...
					<form:input type="text" class="form-control" path="nom" value="${id}" />
				</div>
				...
				<div class="form-group">
					...
					<form:input type="number" step="0.5" class="form-control" path="prix" />
				</div>
				
				<div class="form-group">
					<label>Quantité d'ingredient</label> 
					<form:input type="number" step="0.5" class="form-control" path="quantite" />
				</div>
